...
% source_dir = '/media/juliana/Seagate Backup Plus Drive/RESDATA/20161218_CE024_highres';
% fov_dir = '/posterior1';
% depth_dir = '/posterior1_13/';
% curr_dir = strcat(source_dir, fov_dir, depth_dir)

source_dir = '/media/juliana/Seagate Backup Plus Drive/RESDATA/20161222_JR030W_rsvp1';
run_dir = '/run1';
curr_dir = strcat(source_dir, run_dir);
cd(curr_dir)
...
sliceNum = 9; %1; %Choose a slice to analyze
...
temporalBin = 3; %8; %default (tested w/ 15-30hz imaging), may need adjustment based on frame rate

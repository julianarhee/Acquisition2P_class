...
sliceNum = 10; %Choose a slice to analyze
channelNum = 1; %Choose the GCaMP channel
movNums = []; %this will default to all movie files
radiusPxCov = 5; %default, may need zoom level adjustment
temporalBin = 2; %default (tested w/ 15-30hz imaging), may need adjustment based on frame rate
